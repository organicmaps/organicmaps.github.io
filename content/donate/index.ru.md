...
Нажмите на значок предпочитаемого вами способа оплаты ниже:

{{ donate_buttons() }}

Регулярные пожертвования – лучший способ обеспечить относительно стабильный доход для
проект и мотивировать нас на долгосрочные задачи и цели. Но вы также можете
пожертвовать один раз.
